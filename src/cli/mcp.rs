...
pub async fn handle_mcp(cmd: McpCommands) -> Result<()> {
    match cmd {
        ...
        McpCommands::Add {
            ...
            command,
            args,
        } => handle_add(name, command, args).await,
...
async fn handle_add(name: String, command: String, args: Vec<String>) -> Result<()> {
    ...
    println!(
        "{} {}",
        console::style("✓").green(),
        console::style(format!("Added server '{}'", name)).bold()
    );
...
async fn handle_remove(name: String) -> Result<()> {
    ...
    println!(
        "{} {}",
        console::style("✓").green(),
        console::style(format!("Removed server '{}'", name)).bold()
    );
...
async fn handle_connect(name: String) -> Result<()> {
    ...
    println!(
        "{}",
        console::style(format!("Connecting to '{}'...", name)).dim()
    );
...
async fn handle_disconnect(name: String) -> Result<()> {
    ...
    println!(
        "{} {}",
        console::style("✓").green(),
        console::style(format!("Disconnected from '{}'", name)).bold()
    );
...
async fn handle_resources(server: String) -> Result<()> {
    ...
    println!(
        "\n{} from '{}':\n",
        console::style("Resources").cyan().bold(),
        server
    );
...
async fn handle_prompts(server: String) -> Result<()> {
    ...
    println!(
        "\n{} from '{}':\n",
        console::style("Prompts").cyan().bold(),
        server
    );
