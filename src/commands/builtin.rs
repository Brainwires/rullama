...
pub fn register_builtin_commands(registry: &mut CommandRegistry) {
    ...
    registry.register(
        ...
        .with_arg("name".to_string(), Some("Model name to switch to (optional - omit to list models)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("steps".to_string(), Some("Number of steps to rewind".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("name".to_string(), Some("Optional checkpoint name".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("id".to_string(), Some("Checkpoint ID or index (1-based)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("conversation_id".to_string(), Some("Optional: specific conversation ID to load".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("task".to_string(), Some("Description of the task to plan".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("conversation_id".to_string(), Some("Optional: filter by conversation ID".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("plan_id".to_string(), Some("Plan ID to display".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("plan_id".to_string(), Some("Plan ID to delete".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("plan_id".to_string(), Some("Plan ID to activate".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("plan_id".to_string(), Some("Plan ID to resume".to_string()), true)
    );
    ...
    registry.register(
        Command::builtin(
            ...
            "Execute a plan with AI-driven task completion (modes: suggest, auto-edit, full-auto)".to_string(),
            "".to_string(),
        )
        .with_arg("plan_id".to_string(), Some("Plan ID to execute".to_string()), true)
        .with_arg("mode".to_string(), Some("Approval mode: suggest, auto-edit, or full-auto (default: full-auto)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("name".to_string(), Some("Branch name (e.g., 'auth-feature')".to_string()), true)
        .with_arg("task".to_string(), Some("Task description for the branch".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("plan_id".to_string(), Some("Branch plan ID to merge (optional, defaults to active plan)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("plan_id".to_string(), Some("Plan ID to show hierarchy for (optional, defaults to active plan)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("task_id".to_string(), Some("Task ID to complete (optional)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("task_id".to_string(), Some("Task ID to skip (optional - defaults to current)".to_string()), false)
        .with_arg("reason".to_string(), Some("Reason for skipping".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("description".to_string(), Some("Task description".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("task_id".to_string(), Some("Task ID to start".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("task_id".to_string(), Some("Task ID to block".to_string()), true)
        .with_arg("reason".to_string(), Some("Reason for blocking".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("task_id".to_string(), Some("Task that will depend on another".to_string()), true)
        .with_arg("depends_on".to_string(), Some("Task to depend on".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("task_id".to_string(), Some("Task ID (optional - shows all if omitted)".to_string()), false)
    );
    ...
    registry.register(
        Command::builtin(
            ...
            "Load project-specific instructions from BRAINWIRES.md (supports @file.md imports)".to_string(),
            "".to_string(),
        )
    );
    ...
    registry.register(
        ...
        .with_arg("command".to_string(), Some("Shell command to execute".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("path".to_string(), Some("Path to codebase directory".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("query".to_string(), Some("Search query".to_string()), true)
        .with_arg("extensions".to_string(), Some("Comma-separated file extensions (e.g., rs,toml)".to_string()), false)
        .with_arg("languages".to_string(), Some("Comma-separated languages (e.g., Rust,Python)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("query".to_string(), Some("Search query for commit messages".to_string()), true)
        .with_arg("max_commits".to_string(), Some("Maximum commits to search (default: 10)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("file".to_string(), Some("File path containing the symbol".to_string()), true)
        .with_arg("line".to_string(), Some("Line number (1-based)".to_string()), true)
        .with_arg("column".to_string(), Some("Column number (0-based)".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("line".to_string(), Some("Line number (1-based)".to_string()), true)
        .with_arg("column".to_string(), Some("Column number (0-based)".to_string()), true)
        .with_arg("limit".to_string(), Some("Maximum references to return (default: 100)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("file".to_string(), Some("File path containing the function".to_string()), true)
        .with_arg("line".to_string(), Some("Line number (1-based)".to_string()), true)
        .with_arg("column".to_string(), Some("Column number (0-based)".to_string()), true)
        .with_arg("depth".to_string(), Some("Maximum traversal depth (default: 2)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("description".to_string(), Some("Template description".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("name".to_string(), Some("Template name or ID".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("name".to_string(), Some("Template name or ID".to_string()), true)
        .with_arg("vars".to_string(), Some("Variable substitutions as key=value pairs".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("pinned".to_string(), Some("Pin file to prevent eviction (true/false)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("path".to_string(), Some("Path to file to remove".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("path".to_string(), Some("Path to file to pin".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("path".to_string(), Some("Path to file to unpin".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("keep_pinned".to_string(), Some("Keep pinned files (true/false, default: true)".to_string()), false)
    );
    ...
    registry.register(
        Command::builtin(
            "ask".to_string(),
            "Switch to Ask mode (read-only). Optionally provide a question to ask immediately.".to_string(),
            "".to_string(),
        )
        .with_arg("query".to_string(), Some("Optional question to ask in read-only mode".to_string()), false)
    );
    ...
    registry.register(
        Command::builtin(
            "tools".to_string(),
            "Configure which tools are available: full, explicit, smart (default), core, or none".to_string(),
            "".to_string(),
        )
        .with_arg("mode".to_string(), Some("Tool mode: full, explicit, smart, core, or none".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("state".to_string(), Some("on/off to enable/disable MDAP mode".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("value".to_string(), Some("Vote margin (1-10, default: 3)".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("rate".to_string(), Some("Target rate as decimal (0.95) or percentage (95%)".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("rule".to_string(), Some("The behavioral rule to learn (e.g., \"pm2 logs requires --nostream\")".to_string()), true)
        .with_arg("rationale".to_string(), Some("Why this is better (optional)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("category".to_string(), Some("Filter by category: command, strategy, tool, error, resource, pattern".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("id".to_string(), Some("Truth ID to contradict".to_string()), true)
        .with_arg("reason".to_string(), Some("Reason for contradiction (optional)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("id".to_string(), Some("Truth ID to delete".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("key".to_string(), Some("Fact key (e.g., name, preferred_language, current_project)".to_string()), true)
        .with_arg("value".to_string(), Some("Fact value".to_string()), true)
        .with_arg("local".to_string(), Some("Set to 'true' to keep this fact local-only (never synced)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("category".to_string(), Some("Filter by: identity, preference, capability, context, constraint, relationship".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("id".to_string(), Some("Fact ID or key to delete".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("file".to_string(), Some("Output file path (default: ~/brainwires-profile.json)".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("file".to_string(), Some("JSON file to import".to_string()), true)
    );
    ...
    registry.register(
        Command::builtin(
            "remember".to_string(),
            "Quick command to remember contextual facts (auto-generates key from content)".to_string(),
            "".to_string(),
        )
        .with_arg("fact".to_string(), Some("The fact to remember (entire remaining text)".to_string()), true)
    );
    ...
    registry.register(
        ...
        .with_arg("name".to_string(), Some("Skill name to invoke".to_string()), true)
        .with_arg("args".to_string(), Some("Optional arguments as key=value pairs".to_string()), false)
    );
    ...
    registry.register(
        ...
        .with_arg("name".to_string(), Some("Skill name (lowercase, hyphens only)".to_string()), true)
        .with_arg("location".to_string(), Some("personal or project (default: personal)".to_string()), false)
    );
}
