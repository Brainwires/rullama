...
impl App {
    ...
    pub(super) async fn handle_learn_truth(&mut self, rule: &str, rationale: Option<&str>) {
        ...
        use rullama::knowledge::bks_pks::cache::BehavioralKnowledgeCache;
        use rullama::knowledge::bks_pks::truth::{BehavioralTruth, TruthCategory, TruthSource};
    ...
    pub(super) async fn handle_knowledge_list(&mut self, category: Option<&str>) {
        use crate::utils::paths::PlatformPaths;
        use rullama::knowledge::bks_pks::cache::BehavioralKnowledgeCache;
        use rullama::knowledge::bks_pks::truth::TruthCategory;
    ...
    pub(super) async fn handle_knowledge_search(&mut self, query: &str) {
        use crate::utils::paths::PlatformPaths;
        use rullama::knowledge::bks_pks::cache::BehavioralKnowledgeCache;
        use rullama::knowledge::bks_pks::matcher::ContextMatcher;
