...
//! are defined here (inference dep lives in CLI, not in rullama-tools).

// Re-export all framework smart_router functions
#[allow(hidden_glob_reexports)]
pub use rullama_tool_runtime::smart_router::*;

// ── CLI-specific: inference-integrated variants ───────────────────────────

use crate::types::message::Message;
use rullama::reasoning::LocalRouter;
use rullama_tool_runtime::{Tool, ToolCategory};
...
use rullama_skills::metadata::SkillMatch;
use rullama_skills::router::SkillRouter;
