...
//!
//! One-stop module for every system prompt used by the rullama CLI.
//!
//! - **Agent prompts** come from the framework: [`rullama::agents::AgentPromptKind`] /
...
pub use rullama::agents::{AgentPromptKind, build_agent_prompt};
