...
pub struct App {
    ...
    pub(super) seal_processor: Option<rullama_seal::SealProcessor>,
    /// Dialog state for SEAL coreference resolution
    pub(super) seal_dialog_state: rullama_seal::DialogState,
    ...
    pub ipc_writer: Option<rullama::agent_network::ipc::IpcWriter>,
    ...
    pub skill_registry: Option<rullama_skills::SkillRegistry>,
    ...
    pub pks_integration: rullama::knowledge::bks_pks::personal::PksIntegration,
...
impl App {
    ...
    pub async fn new_viewer(session_id: String, model: Option<String>) -> Result<Self> {
        ...
        let mut result = Ok(Self {
            ...
            // Skills system
            skill_registry: {
                let mut registry = rullama_skills::SkillRegistry::new();
            ...
            // PKS integration for implicit fact detection and behavioral inference
            pks_integration: rullama::knowledge::bks_pks::personal::PksIntegration::default(),
    ...
    pub fn update_seal_status(&mut self, result: &rullama_seal::SealProcessingResult) {
