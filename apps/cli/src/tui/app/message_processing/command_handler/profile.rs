...
impl App {
    ...
    pub(super) async fn handle_profile_show(&mut self) {
        ...
        use rullama::knowledge::bks_pks::personal::{PersonalFactMatcher, PersonalKnowledgeCache};
    ...
    pub(super) async fn handle_profile_list(&mut self, category: Option<&str>) {
        use crate::utils::paths::PlatformPaths;
        use rullama::knowledge::bks_pks::personal::{PersonalFactCategory, PersonalKnowledgeCache};
    ...
    pub(super) async fn handle_profile_search(&mut self, query: &str) {
        use crate::utils::paths::PlatformPaths;
        use rullama::knowledge::bks_pks::personal::PersonalKnowledgeCache;
